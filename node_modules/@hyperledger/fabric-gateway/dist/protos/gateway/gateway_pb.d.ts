...
export class EndorseRequest extends jspb.Message {
  ...
  clearProposedTransaction(): void;
  getProposedTransaction(): peer_proposal_pb.SignedProposal | undefined;
  setProposedTransaction(value?: peer_proposal_pb.SignedProposal): void;

  clearEndorsingOrganizationsList(): void;
  getEndorsingOrganizationsList(): Array<string>;
  setEndorsingOrganizationsList(value: Array<string>): void;
  addEndorsingOrganizations(value: string, index?: number): string;
...
export class EndorseResponse extends jspb.Message {
  ...
  clearPreparedTransaction(): void;
  getPreparedTransaction(): common_common_pb.Envelope | undefined;
  setPreparedTransaction(value?: common_common_pb.Envelope): void;
...
export class CommitStatusResponse extends jspb.Message {
  getResult(): peer_transaction_pb.TxValidationCodeMap[keyof peer_transaction_pb.TxValidationCodeMap];
  setResult(value: peer_transaction_pb.TxValidationCodeMap[keyof peer_transaction_pb.TxValidationCodeMap]): void;
...
export namespace CommitStatusResponse {
  export type AsObject = {
    result: peer_transaction_pb.TxValidationCodeMap[keyof peer_transaction_pb.TxValidationCodeMap],
    blockNumber: number,
  }
}
...
export class EvaluateRequest extends jspb.Message {
  ...
  clearTargetOrganizationsList(): void;
  getTargetOrganizationsList(): Array<string>;
  setTargetOrganizationsList(value: Array<string>): void;
  addTargetOrganizations(value: string, index?: number): string;
...
export class EvaluateResponse extends jspb.Message {
  ...
  setResult(value?: peer_proposal_response_pb.Response): void;
...
export class ChaincodeEventsRequest extends jspb.Message {
  ...
  setStartPosition(value?: orderer_ab_pb.SeekPosition): void;
...
export class ChaincodeEventsResponse extends jspb.Message {
  ...
  setEventsList(value: Array<peer_chaincode_event_pb.ChaincodeEvent>): void;
...
export class PreparedTransaction extends jspb.Message {
  ...
  setEnvelope(value?: common_common_pb.Envelope): void;
