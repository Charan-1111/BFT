...
class ChaincodeEventsRequestImpl {
    constructor(options) {
        ...
        __classPrivateFieldSet(this, _ChaincodeEventsRequestImpl_signedRequest, new gateway_pb_1.SignedChaincodeEventsRequest(), "f");
        __classPrivateFieldGet(this, _ChaincodeEventsRequestImpl_signedRequest, "f").setRequest(options.request.serializeBinary());
    }
    ...
    getBytes() {
        return __classPrivateFieldGet(this, _ChaincodeEventsRequestImpl_signedRequest, "f").getRequest_asU8();
    }
    getDigest() {
