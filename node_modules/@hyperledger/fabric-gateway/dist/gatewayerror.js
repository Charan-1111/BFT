...
const status_pb_1 = require("./protos/google/rpc/status_pb");
/**
...
function newGatewayError(err) {
    ...
    const details = metadata
        .flatMap(metadataValue => status_pb_1.Status.deserializeBinary(Buffer.from(metadataValue)).getDetailsList())
        .map(statusDetail => {
        const endpointError = gateway_pb_1.ErrorDetail.deserializeBinary(statusDetail.getValue_asU8());
        const detail = {
